      ...
      00001A                        313 _APROM_write_byte_PARM_2:
      00001A                        314 	.ds 1
      ...
      0004A9 E4               [12]  391 	clr	a
      0004AA 93               [24]  392 	movc	a,@a+dptr
                                    393 ;	./src/N76_Flash.c:15: return rdata;
                                    394 ;	./src/N76_Flash.c:16: }
      0004AB F5 82            [12]  395 	mov	dpl,a
      0004AD 22               [24]  396 	ret
                                    397 ;------------------------------------------------------------
                                    ...
                                    406 ;	-----------------------------------------
      0004AE                        407 _APROM_read_2byte:
                                    408 ;	./src/N76_Flash.c:20: rdata = *((uint16_t __code *)u16_addr);
      0004AE E4               [12]  409 	clr	a
      0004AF 93               [24]  410 	movc	a,@a+dptr
      0004B0 FE               [12]  411 	mov	r6,a
      0004B1 A3               [24]  412 	inc	dptr
      0004B2 E4               [12]  413 	clr	a
      0004B3 93               [24]  414 	movc	a,@a+dptr
                                    415 ;	./src/N76_Flash.c:21: return rdata;
                                    416 ;	./src/N76_Flash.c:22: }
      0004B4 8E 82            [24]  417 	mov	dpl,r6
      0004B6 F5 83            [12]  418 	mov	dph,a
      0004B8 22               [24]  419 	ret
                                    420 ;------------------------------------------------------------
                                    ...
                                    429 ;	-----------------------------------------
      0004B9                        430 _APROM_write_byte:
      0004B9 AE 82            [24]  431 	mov	r6,dpl
      0004BB AF 83            [24]  432 	mov	r7,dph
                                    433 ;	./src/N76_Flash.c:30: set_IAPEN; // enable IAP
      0004BD 53 A8 7F         [24]  434 	anl	_ie,#0x7f
      0004C0 75 C7 AA         [24]  435 	mov	_ta,#0xaa
      0004C3 75 C7 55         [24]  436 	mov	_ta,#0x55
      0004C6 43 9F 01         [24]  437 	orl	_chpcon,#0x01
      0004C9 43 A8 80         [24]  438 	orl	_ie,#0x80
                                    439 ;	./src/N76_Flash.c:31: set_APUEN; // enable IAP updated
      0004CC 53 A8 7F         [24]  440 	anl	_ie,#0x7f
      0004CF 75 C7 AA         [24]  441 	mov	_ta,#0xaa
      0004D2 75 C7 55         [24]  442 	mov	_ta,#0x55
      0004D5 43 A5 01         [24]  443 	orl	_iapuen,#0x01
      0004D8 43 A8 80         [24]  444 	orl	_ie,#0x80
                                    445 ;	./src/N76_Flash.c:32: IAPCN = BYTE_PROGRAM_AP;
      0004DB 75 AF 21         [24]  446 	mov	_iapcn,#0x21
                                    447 ;	./src/N76_Flash.c:34: IAPAH = (uint8_t)((addr) >> 8);
      0004DE 8F A7            [24]  448 	mov	_iapah,r7
                                    449 ;	./src/N76_Flash.c:35: IAPAL = (uint8_t)((addr)&0xFF);
      0004E0 8E A6            [24]  450 	mov	_iapal,r6
                                    451 ;	./src/N76_Flash.c:36: IAPFD = data;
      0004E2 85 1A AE         [24]  452 	mov	_iapfd,_APROM_write_byte_PARM_2
                                    453 ;	./src/N76_Flash.c:38: set_IAPGO; // Trigger_IAP();
      0004E5 53 A8 7F         [24]  454 	anl	_ie,#0x7f
      0004E8 75 C7 AA         [24]  455 	mov	_ta,#0xaa
      0004EB 75 C7 55         [24]  456 	mov	_ta,#0x55
      0004EE 43 A4 01         [24]  457 	orl	_iaptrg,#0x01
      0004F1 43 A8 80         [24]  458 	orl	_ie,#0x80
                                    459 ;	./src/N76_Flash.c:40: clr_APUEN;
      0004F4 53 A8 7F         [24]  460 	anl	_ie,#0x7f
      0004F7 75 C7 AA         [24]  461 	mov	_ta,#0xaa
      0004FA 75 C7 55         [24]  462 	mov	_ta,#0x55
      0004FD 53 A5 FE         [24]  463 	anl	_iapuen,#0xfe
      000500 43 A8 80         [24]  464 	orl	_ie,#0x80
                                    465 ;	./src/N76_Flash.c:41: clr_IAPEN;
      000503 53 A8 7F         [24]  466 	anl	_ie,#0x7f
      000506 75 C7 AA         [24]  467 	mov	_ta,#0xaa
      000509 75 C7 55         [24]  468 	mov	_ta,#0x55
      00050C 53 9F FE         [24]  469 	anl	_chpcon,#0xfe
      00050F 43 A8 80         [24]  470 	orl	_ie,#0x80
                                    471 ;	./src/N76_Flash.c:42: }
      000512 22               [24]  472 	ret
                                    473 ;------------------------------------------------------------
                                    ...
                                    481 ;	-----------------------------------------
      000513                        482 _Erase_APROM:
      000513 AE 82            [24]  483 	mov	r6,dpl
      000515 AF 83            [24]  484 	mov	r7,dph
                                    485 ;	./src/N76_Flash.c:47: setbAP(CHPCON, IAPEN); // enable IAP
      000517 53 A8 7F         [24]  486 	anl	_ie,#0x7f
      00051A 75 C7 AA         [24]  487 	mov	_ta,#0xaa
      00051D 75 C7 55         [24]  488 	mov	_ta,#0x55
      000520 43 9F 01         [24]  489 	orl	_chpcon,#0x01
      000523 43 A8 80         [24]  490 	orl	_ie,#0x80
                                    491 ;	./src/N76_Flash.c:48: IAPFD = 0xFF;												// IMPORTANT !! To erase function must setting IAPFD = 0xFF 
      000526 75 AE FF         [24]  492 	mov	_iapfd,#0xff
                                    493 ;	./src/N76_Flash.c:49: IAPCN = PAGE_ERASE_AP;
      000529 75 AF 22         [24]  494 	mov	_iapcn,#0x22
                                    495 ;	./src/N76_Flash.c:50: set_APUEN; // enable IAP updated
      00052C 53 A8 7F         [24]  496 	anl	_ie,#0x7f
      00052F 75 C7 AA         [24]  497 	mov	_ta,#0xaa
      000532 75 C7 55         [24]  498 	mov	_ta,#0x55
      000535 43 A5 01         [24]  499 	orl	_iapuen,#0x01
      000538 43 A8 80         [24]  500 	orl	_ie,#0x80
                                    501 ;	./src/N76_Flash.c:54: IAPAH = (uint8_t)((addr) >> 8);
      00053B 8F A7            [24]  502 	mov	_iapah,r7
                                    503 ;	./src/N76_Flash.c:55: IAPAL = (uint8_t)((addr)&0xFF);
      00053D 8E A6            [24]  504 	mov	_iapal,r6
                                    505 ;	./src/N76_Flash.c:56: set_IAPGO; // Trigger_IAP();
      00053F 53 A8 7F         [24]  506 	anl	_ie,#0x7f
      000542 75 C7 AA         [24]  507 	mov	_ta,#0xaa
      000545 75 C7 55         [24]  508 	mov	_ta,#0x55
      000548 43 A4 01         [24]  509 	orl	_iaptrg,#0x01
      00054B 43 A8 80         [24]  510 	orl	_ie,#0x80
                                    511 ;	./src/N76_Flash.c:58: clr_APUEN;
      00054E 53 A8 7F         [24]  512 	anl	_ie,#0x7f
      000551 75 C7 AA         [24]  513 	mov	_ta,#0xaa
      000554 75 C7 55         [24]  514 	mov	_ta,#0x55
      000557 53 A5 FE         [24]  515 	anl	_iapuen,#0xfe
      00055A 43 A8 80         [24]  516 	orl	_ie,#0x80
                                    517 ;	./src/N76_Flash.c:59: clr_IAPEN;
      00055D 53 A8 7F         [24]  518 	anl	_ie,#0x7f
      000560 75 C7 AA         [24]  519 	mov	_ta,#0xaa
      000563 75 C7 55         [24]  520 	mov	_ta,#0x55
      000566 53 9F FE         [24]  521 	anl	_chpcon,#0xfe
      000569 43 A8 80         [24]  522 	orl	_ie,#0x80
                                    523 ;	./src/N76_Flash.c:60: }
      00056C 22               [24]  524 	ret
                                    525 	.area CSEG    (CODE)
                                    526 	.area CONST   (CODE)
                                    527 	.area XINIT   (CODE)
