      ...
      00041B                        372 __delay_ms:
                           ...
                           000001   379 	ar1 = 0x01
                           000000   380 	ar0 = 0x00
      00041B AC 82            [24]  381 	mov	r4,dpl
      00041D AD 83            [24]  382 	mov	r5,dph
      00041F AE F0            [24]  383 	mov	r6,b
      000421 FF               [12]  384 	mov	r7,a
                                    385 ;	./src/include.c:12: T3CON |= 0x07;                           		//Timer3 Clock = Fsys/128
      000422 43 C4 07         [24]  386 	orl	_t3con,#0x07
                                    387 ;	./src/include.c:13: set_TR3;                                		//Trigger Timer3 start run
      000425 43 C4 08         [24]  388 	orl	_t3con,#0x08
                                    389 ;	./src/include.c:14: while (__ms != 0)
      000428                        390 00104$:
      000428 EC               [12]  391 	mov	a,r4
      000429 4D               [12]  392 	orl	a,r5
      00042A 4E               [12]  393 	orl	a,r6
      00042B 4F               [12]  394 	orl	a,r7
      00042C 60 23            [24]  395 	jz	00106$
                                    396 ;	./src/include.c:16: RL3 = 0x83; //Find  define in "Function_define.h" "TIMER VALUE"
      00042E 75 C5 83         [24]  397 	mov	_rl3,#0x83
                                    398 ;	./src/include.c:17: RH3 = 0xFF;
      000431 75 C6 FF         [24]  399 	mov	_rh3,#0xff
                                    400 ;	./src/include.c:18: while (inbit(T3CON,TF3) != 1);		//Check Timer3 Time-Out Flag
      000434                        401 00101$:
      000434 74 10            [12]  402 	mov	a,#0x10
      000436 55 C4            [12]  403 	anl	a,_t3con
      000438 C4               [12]  404 	swap	a
      000439 54 0F            [12]  405 	anl	a,#0x0f
      00043B FB               [12]  406 	mov	r3,a
      00043C BB 01 F5         [24]  407 	cjne	r3,#0x01,00101$
                                    408 ;	./src/include.c:19: clr_TF3;
      00043F 53 C4 EF         [24]  409 	anl	_t3con,#0xef
                                    410 ;	./src/include.c:22: __ms--;
      000442 1C               [12]  411 	dec	r4
      000443 BC FF 09         [24]  412 	cjne	r4,#0xff,00129$
      000446 1D               [12]  413 	dec	r5
      000447 BD FF 05         [24]  414 	cjne	r5,#0xff,00129$
      00044A 1E               [12]  415 	dec	r6
      00044B BE FF 01         [24]  416 	cjne	r6,#0xff,00129$
      00044E 1F               [12]  417 	dec	r7
      00044F                        418 00129$:
      00044F 80 D7            [24]  419 	sjmp	00104$
      000451                        420 00106$:
                                    421 ;	./src/include.c:24: clr_TR3;                                		//Stop Timer3
      000451 53 C4 F7         [24]  422 	anl	_t3con,#0xf7
                                    423 ;	./src/include.c:25: }
      000454 22               [24]  424 	ret
                                    425 ;------------------------------------------------------------
                                    ...
                                    433 ;	-----------------------------------------
      000455                        434 __delay_us:
      000455 85 82 1A         [24]  435 	mov	__mullong_PARM_2,dpl
      000458 85 83 1B         [24]  436 	mov	(__mullong_PARM_2 + 1),dph
      00045B 85 F0 1C         [24]  437 	mov	(__mullong_PARM_2 + 2),b
      00045E F5 1D            [12]  438 	mov	(__mullong_PARM_2 + 3),a
                                    439 ;	./src/include.c:29: _us = _us * 5 / 4+1;
      000460 90 00 05         [24]  440 	mov	dptr,#(0x05&0x00ff)
      000463 E4               [12]  441 	clr	a
      000464 F5 F0            [12]  442 	mov	b,a
      000466 12 07 56         [24]  443 	lcall	__mullong
      000469 AC 82            [24]  444 	mov	r4,dpl
      00046B AD 83            [24]  445 	mov	r5,dph
      00046D AE F0            [24]  446 	mov	r6,b
      00046F C3               [12]  447 	clr	c
      000470 13               [12]  448 	rrc	a
      000471 FF               [12]  449 	mov	r7,a
      000472 EE               [12]  450 	mov	a,r6
      000473 13               [12]  451 	rrc	a
      000474 FE               [12]  452 	mov	r6,a
      000475 ED               [12]  453 	mov	a,r5
      000476 13               [12]  454 	rrc	a
      000477 FD               [12]  455 	mov	r5,a
      000478 EC               [12]  456 	mov	a,r4
      000479 13               [12]  457 	rrc	a
      00047A FC               [12]  458 	mov	r4,a
      00047B EF               [12]  459 	mov	a,r7
      00047C C3               [12]  460 	clr	c
      00047D 13               [12]  461 	rrc	a
      00047E FF               [12]  462 	mov	r7,a
      00047F EE               [12]  463 	mov	a,r6
      000480 13               [12]  464 	rrc	a
      000481 FE               [12]  465 	mov	r6,a
      000482 ED               [12]  466 	mov	a,r5
      000483 13               [12]  467 	rrc	a
      000484 FD               [12]  468 	mov	r5,a
      000485 EC               [12]  469 	mov	a,r4
      000486 13               [12]  470 	rrc	a
      000487 FC               [12]  471 	mov	r4,a
      000488 0C               [12]  472 	inc	r4
      000489 BC 00 09         [24]  473 	cjne	r4,#0x00,00112$
      00048C 0D               [12]  474 	inc	r5
      00048D BD 00 05         [24]  475 	cjne	r5,#0x00,00112$
      000490 0E               [12]  476 	inc	r6
      000491 BE 00 01         [24]  477 	cjne	r6,#0x00,00112$
      000494 0F               [12]  478 	inc	r7
      000495                        479 00112$:
                                    480 ;	./src/include.c:30: while (--_us)
      000495                        481 00101$:
      000495 1C               [12]  482 	dec	r4
      000496 BC FF 09         [24]  483 	cjne	r4,#0xff,00113$
      000499 1D               [12]  484 	dec	r5
      00049A BD FF 05         [24]  485 	cjne	r5,#0xff,00113$
      00049D 1E               [12]  486 	dec	r6
      00049E BE FF 01         [24]  487 	cjne	r6,#0xff,00113$
      0004A1 1F               [12]  488 	dec	r7
      0004A2                        489 00113$:
      0004A2 EC               [12]  490 	mov	a,r4
      0004A3 4D               [12]  491 	orl	a,r5
      0004A4 4E               [12]  492 	orl	a,r6
      0004A5 4F               [12]  493 	orl	a,r7
      0004A6 70 ED            [24]  494 	jnz	00101$
                                    495 ;	./src/include.c:35: }
      0004A8 22               [24]  496 	ret
                                    497 	.area CSEG    (CODE)
                                    498 	.area CONST   (CODE)
                                    499 	.area XINIT   (CODE)
