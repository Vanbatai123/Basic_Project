      ...
      000146 43 C9 60         [24]  624 	orl	_t2mod,#0x60
                                    625 ;	./N76_WS2812.c:100: clrb(TCON, CM_RL2);
      000149 53 88 FE         [24]  626 	anl	_tcon,#0xfe
                                    627 ;	./N76_WS2812.c:104: setb(T2MOD, CAPCR);
      00014C 43 C9 08         [24]  628 	orl	_t2mod,#0x08
                                    629 ;	./N76_WS2812.c:105: setb(T2MOD, LDEN);
      ...
      00015B 75 CD 00         [24]  638 	mov	_th2,#0x00
                                    639 ;	./N76_WS2812.c:114: setb(EIE, ET2); // Enable Timer2 interrupt
      00015E 43 9B 80         [24]  640 	orl	_eie,#0x80
                                    641 ;	./N76_WS2812.c:115: sei();
      000161 43 A8 80         [24]  642 	orl	_ie,#0x80
                                    643 ;	./N76_WS2812.c:116: setb(T2CON, TR2); // Timer2 run
      ...
      0001E3 43 E1 01         [24]  736 	orl	_adccon1,#0x01
                                    737 ;	./N76_WS2812.c:173: setb(IE, EADC); // enable interruppt ADC
      0001E6 43 A8 40         [24]  738 	orl	_ie,#0x40
                                    739 ;	./N76_WS2812.c:176: setb(PICON, PIPS0); // pin interrupt port 1
      0001E9 43 E9 01         [24]  740 	orl	_picon,#0x01
                                    741 ;	./N76_WS2812.c:178: setb(PICON, PIT45);
      ...
      0001F2 53 EB EF         [24]  746 	anl	_pipen,#0xef
                                    747 ;	./N76_WS2812.c:181: setb(PICON, PIT3);
      ...
      0001FB 53 EB F7         [24]  752 	anl	_pipen,#0xf7
                                    753 ;	./N76_WS2812.c:186: setb(EIE, EPI); // set external interrupt 0 at falling edge
      ...
      000520 8F 0B            [24] 1214 	mov	(__delay + 1),r7
                                   1215 ;	./N76_WS2812.c:316: clrb(ADCCON0, ADCF);
      ...
      000623 12 07 54         [24] 1380 	lcall	_APROM_write_byte
                                   1381 ;	./N76_WS2812.c:367: clrb(EIE, EPI);                       // clear pin interrupt
      ...
      00068C                       1458 00119$:
                                   1459 ;	./N76_WS2812.c:393: setb(ADCCON0, ADCS);
      ...
      000696                       1467 00123$:
                                   1468 ;	./N76_WS2812.c:400: clrb(T2CON, TF2); // TF2
