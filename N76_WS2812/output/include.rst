      ...
      0006B6                        372 __delay_ms:
                           ...
                           000001   379 	ar1 = 0x01
                           000000   380 	ar0 = 0x00
      0006B6 AC 82            [24]  381 	mov	r4,dpl
      0006B8 AD 83            [24]  382 	mov	r5,dph
      0006BA AE F0            [24]  383 	mov	r6,b
      ...
      0006C3                        390 00104$:
      0006C3 EC               [12]  391 	mov	a,r4
      0006C4 4D               [12]  392 	orl	a,r5
      0006C5 4E               [12]  393 	orl	a,r6
      0006C6 4F               [12]  394 	orl	a,r7
      0006C7 60 23            [24]  395 	jz	00106$
                                    396 ;	./src/include.c:16: RL3 = 0x83; //Find  define in "Function_define.h" "TIMER VALUE"
      0006C9 75 C5 83         [24]  397 	mov	_rl3,#0x83
                                    398 ;	./src/include.c:17: RH3 = 0xFF;
      0006CC 75 C6 FF         [24]  399 	mov	_rh3,#0xff
                                    400 ;	./src/include.c:18: while (inbit(T3CON,TF3) != 1);		//Check Timer3 Time-Out Flag
      0006CF                        401 00101$:
      0006CF 74 10            [12]  402 	mov	a,#0x10
      0006D1 55 C4            [12]  403 	anl	a,_t3con
      0006D3 C4               [12]  404 	swap	a
      ...
      0006DE BC FF 09         [24]  412 	cjne	r4,#0xff,00129$
      0006E1 1D               [12]  413 	dec	r5
      0006E2 BD FF 05         [24]  414 	cjne	r5,#0xff,00129$
      0006E5 1E               [12]  415 	dec	r6
      0006E6 BE FF 01         [24]  416 	cjne	r6,#0xff,00129$
      0006E9 1F               [12]  417 	dec	r7
      0006EA                        418 00129$:
      ...
      0006EF 22               [24]  424 	ret
                                    ...
                                    433 ;	-----------------------------------------
      0006F0                        434 __delay_us:
      0006F0 85 82 16         [24]  435 	mov	__mullong_PARM_2,dpl
      0006F3 85 83 17         [24]  436 	mov	(__mullong_PARM_2 + 1),dph
      0006F6 85 F0 18         [24]  437 	mov	(__mullong_PARM_2 + 2),b
      0006F9 F5 19            [12]  438 	mov	(__mullong_PARM_2 + 3),a
                                    439 ;	./src/include.c:29: _us = _us * 5 / 4+1;
      0006FB 90 00 05         [24]  440 	mov	dptr,#(0x05&0x00ff)
      0006FE E4               [12]  441 	clr	a
      0006FF F5 F0            [12]  442 	mov	b,a
      000701 12 1F 02         [24]  443 	lcall	__mullong
      000704 AC 82            [24]  444 	mov	r4,dpl
      000706 AD 83            [24]  445 	mov	r5,dph
      000708 AE F0            [24]  446 	mov	r6,b
      00070A C3               [12]  447 	clr	c
      00070B 13               [12]  448 	rrc	a
      00070C FF               [12]  449 	mov	r7,a
      00070D EE               [12]  450 	mov	a,r6
      00070E 13               [12]  451 	rrc	a
      00070F FE               [12]  452 	mov	r6,a
      000710 ED               [12]  453 	mov	a,r5
      000711 13               [12]  454 	rrc	a
      000712 FD               [12]  455 	mov	r5,a
      000713 EC               [12]  456 	mov	a,r4
      000714 13               [12]  457 	rrc	a
      000715 FC               [12]  458 	mov	r4,a
      000716 EF               [12]  459 	mov	a,r7
      000717 C3               [12]  460 	clr	c
      000718 13               [12]  461 	rrc	a
      000719 FF               [12]  462 	mov	r7,a
      00071A EE               [12]  463 	mov	a,r6
      00071B 13               [12]  464 	rrc	a
      00071C FE               [12]  465 	mov	r6,a
      00071D ED               [12]  466 	mov	a,r5
      00071E 13               [12]  467 	rrc	a
      00071F FD               [12]  468 	mov	r5,a
      000720 EC               [12]  469 	mov	a,r4
      000721 13               [12]  470 	rrc	a
      000722 FC               [12]  471 	mov	r4,a
      000723 0C               [12]  472 	inc	r4
      000724 BC 00 09         [24]  473 	cjne	r4,#0x00,00112$
      000727 0D               [12]  474 	inc	r5
      000728 BD 00 05         [24]  475 	cjne	r5,#0x00,00112$
      00072B 0E               [12]  476 	inc	r6
      00072C BE 00 01         [24]  477 	cjne	r6,#0x00,00112$
      00072F 0F               [12]  478 	inc	r7
      000730                        479 00112$:
                                    480 ;	./src/include.c:30: while (--_us)
      000730                        481 00101$:
      000730 1C               [12]  482 	dec	r4
      000731 BC FF 09         [24]  483 	cjne	r4,#0xff,00113$
      000734 1D               [12]  484 	dec	r5
      000735 BD FF 05         [24]  485 	cjne	r5,#0xff,00113$
      000738 1E               [12]  486 	dec	r6
      000739 BE FF 01         [24]  487 	cjne	r6,#0xff,00113$
      00073C 1F               [12]  488 	dec	r7
      00073D                        489 00113$:
      00073D EC               [12]  490 	mov	a,r4
      00073E 4D               [12]  491 	orl	a,r5
      00073F 4E               [12]  492 	orl	a,r6
      000740 4F               [12]  493 	orl	a,r7
      000741 70 ED            [24]  494 	jnz	00101$
                                    495 ;	./src/include.c:35: }
      000743 22               [24]  496 	ret
                                    497 	.area CSEG    (CODE)
                                    498 	.area CONST   (CODE)
                                    499 	.area XINIT   (CODE)
