      ...
      00000C                        313 _APROM_write_byte_PARM_2:
      00000C                        314 	.ds 1
      ...
      0015C6 E4               [12]  391 	clr	a
      0015C7 93               [24]  392 	movc	a,@a+dptr
                                    393 ;	./src/N76_Flash.c:15: return rdata;
                                    394 ;	./src/N76_Flash.c:16: }
      0015C8 F5 82            [12]  395 	mov	dpl,a
      0015CA 22               [24]  396 	ret
                                    397 ;------------------------------------------------------------
                                    ...
                                    406 ;	-----------------------------------------
      0015CB                        407 _APROM_read_2byte:
                                    408 ;	./src/N76_Flash.c:20: rdata = *((uint16_t __code *)u16_addr);
      0015CB E4               [12]  409 	clr	a
      0015CC 93               [24]  410 	movc	a,@a+dptr
      0015CD FE               [12]  411 	mov	r6,a
      0015CE A3               [24]  412 	inc	dptr
      0015CF E4               [12]  413 	clr	a
      0015D0 93               [24]  414 	movc	a,@a+dptr
                                    415 ;	./src/N76_Flash.c:21: return rdata;
                                    416 ;	./src/N76_Flash.c:22: }
      0015D1 8E 82            [24]  417 	mov	dpl,r6
      0015D3 F5 83            [12]  418 	mov	dph,a
      0015D5 22               [24]  419 	ret
                                    420 ;------------------------------------------------------------
                                    ...
                                    429 ;	-----------------------------------------
      0015D6                        430 _APROM_write_byte:
      0015D6 AE 82            [24]  431 	mov	r6,dpl
      0015D8 AF 83            [24]  432 	mov	r7,dph
                                    433 ;	./src/N76_Flash.c:30: setbAP(CHPCON, IAPEN); // enable IAP
      0015DA 53 A8 7F         [24]  434 	anl	_ie,#0x7f
      0015DD 75 C7 AA         [24]  435 	mov	_ta,#0xaa
      0015E0 75 C7 55         [24]  436 	mov	_ta,#0x55
      0015E3 43 9F 01         [24]  437 	orl	_chpcon,#0x01
      0015E6 43 A8 80         [24]  438 	orl	_ie,#0x80
                                    439 ;	./src/N76_Flash.c:31: setbAP(IAPUEN, APUEN); // enable IAP updated
      0015E9 53 A8 7F         [24]  440 	anl	_ie,#0x7f
      0015EC 75 C7 AA         [24]  441 	mov	_ta,#0xaa
      0015EF 75 C7 55         [24]  442 	mov	_ta,#0x55
      0015F2 43 A5 01         [24]  443 	orl	_iapuen,#0x01
      0015F5 43 A8 80         [24]  444 	orl	_ie,#0x80
                                    445 ;	./src/N76_Flash.c:32: IAPCN = BYTE_PROGRAM_AP;
      0015F8 75 AF 21         [24]  446 	mov	_iapcn,#0x21
                                    447 ;	./src/N76_Flash.c:34: IAPAH = (uint8_t)((addr) >> 8);
      0015FB 8F A7            [24]  448 	mov	_iapah,r7
                                    449 ;	./src/N76_Flash.c:35: IAPAL = (uint8_t)((addr)&0xFF);
      0015FD 8E A6            [24]  450 	mov	_iapal,r6
                                    451 ;	./src/N76_Flash.c:36: IAPFD = data;
      0015FF 85 0C AE         [24]  452 	mov	_iapfd,_APROM_write_byte_PARM_2
                                    453 ;	./src/N76_Flash.c:38: setbAP(IAPTRG, IAPGO); // Trigger_IAP();
      001602 53 A8 7F         [24]  454 	anl	_ie,#0x7f
      001605 75 C7 AA         [24]  455 	mov	_ta,#0xaa
      001608 75 C7 55         [24]  456 	mov	_ta,#0x55
      00160B 43 A4 01         [24]  457 	orl	_iaptrg,#0x01
      00160E 43 A8 80         [24]  458 	orl	_ie,#0x80
                                    459 ;	./src/N76_Flash.c:40: clrbAP(IAPUEN, APUEN);
      001611 53 A8 7F         [24]  460 	anl	_ie,#0x7f
      001614 75 C7 AA         [24]  461 	mov	_ta,#0xaa
      001617 75 C7 55         [24]  462 	mov	_ta,#0x55
      00161A 53 A5 FE         [24]  463 	anl	_iapuen,#0xfe
      00161D 43 A8 80         [24]  464 	orl	_ie,#0x80
                                    465 ;	./src/N76_Flash.c:41: clrbAP(CHPCON, IAPEN);
      001620 53 A8 7F         [24]  466 	anl	_ie,#0x7f
      001623 75 C7 AA         [24]  467 	mov	_ta,#0xaa
      001626 75 C7 55         [24]  468 	mov	_ta,#0x55
      001629 53 9F FE         [24]  469 	anl	_chpcon,#0xfe
      00162C 43 A8 80         [24]  470 	orl	_ie,#0x80
                                    471 ;	./src/N76_Flash.c:42: }
      00162F 22               [24]  472 	ret
                                    473 ;------------------------------------------------------------
                                    ...
                                    481 ;	-----------------------------------------
      001630                        482 _Erase_APROM:
      001630 AE 82            [24]  483 	mov	r6,dpl
      001632 AF 83            [24]  484 	mov	r7,dph
                                    485 ;	./src/N76_Flash.c:47: setbAP(CHPCON, IAPEN); // enable IAP
      001634 53 A8 7F         [24]  486 	anl	_ie,#0x7f
      001637 75 C7 AA         [24]  487 	mov	_ta,#0xaa
      00163A 75 C7 55         [24]  488 	mov	_ta,#0x55
      00163D 43 9F 01         [24]  489 	orl	_chpcon,#0x01
      001640 43 A8 80         [24]  490 	orl	_ie,#0x80
                                    491 ;	./src/N76_Flash.c:48: IAPFD = 0xFF;												// IMPORTANT !! To erase function must setting IAPFD = 0xFF 
      001643 75 AE FF         [24]  492 	mov	_iapfd,#0xff
                                    493 ;	./src/N76_Flash.c:49: IAPCN = PAGE_ERASE_AP;
      001646 75 AF 22         [24]  494 	mov	_iapcn,#0x22
                                    495 ;	./src/N76_Flash.c:50: setbAP(IAPUEN, APUEN); // enable IAP updated
      001649 53 A8 7F         [24]  496 	anl	_ie,#0x7f
      00164C 75 C7 AA         [24]  497 	mov	_ta,#0xaa
      00164F 75 C7 55         [24]  498 	mov	_ta,#0x55
      001652 43 A5 01         [24]  499 	orl	_iapuen,#0x01
      001655 43 A8 80         [24]  500 	orl	_ie,#0x80
                                    501 ;	./src/N76_Flash.c:54: IAPAH = (uint8_t)((addr) >> 8);
      001658 8F A7            [24]  502 	mov	_iapah,r7
                                    503 ;	./src/N76_Flash.c:55: IAPAL = (uint8_t)((addr)&0xFF);
      00165A 8E A6            [24]  504 	mov	_iapal,r6
                                    505 ;	./src/N76_Flash.c:56: setbAP(IAPTRG, IAPGO); // Trigger_IAP();
      00165C 53 A8 7F         [24]  506 	anl	_ie,#0x7f
      00165F 75 C7 AA         [24]  507 	mov	_ta,#0xaa
      001662 75 C7 55         [24]  508 	mov	_ta,#0x55
      001665 43 A4 01         [24]  509 	orl	_iaptrg,#0x01
      001668 43 A8 80         [24]  510 	orl	_ie,#0x80
                                    511 ;	./src/N76_Flash.c:58: clrbAP(IAPUEN, APUEN);
      00166B 53 A8 7F         [24]  512 	anl	_ie,#0x7f
      00166E 75 C7 AA         [24]  513 	mov	_ta,#0xaa
      001671 75 C7 55         [24]  514 	mov	_ta,#0x55
      001674 53 A5 FE         [24]  515 	anl	_iapuen,#0xfe
      001677 43 A8 80         [24]  516 	orl	_ie,#0x80
                                    517 ;	./src/N76_Flash.c:59: clrbAP(CHPCON, IAPEN);
      00167A 53 A8 7F         [24]  518 	anl	_ie,#0x7f
      00167D 75 C7 AA         [24]  519 	mov	_ta,#0xaa
      001680 75 C7 55         [24]  520 	mov	_ta,#0x55
      001683 53 9F FE         [24]  521 	anl	_chpcon,#0xfe
      001686 43 A8 80         [24]  522 	orl	_ie,#0x80
                                    523 ;	./src/N76_Flash.c:60: }
      001689 22               [24]  524 	ret
                                    525 	.area CSEG    (CODE)
                                    526 	.area CONST   (CODE)
                                    527 	.area XINIT   (CODE)
